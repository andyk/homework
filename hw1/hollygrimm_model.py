# Copied and pasted from hollygrimm's public repo w/ her HW1 solution in an attempt to reproducde
...
class Model:
    def __init__(self, obs_samples, num_observations, num_actions, checkpoint_dir, logger,
    ...
    def fc_layer(self, input_tensor, input_dim, output_dim, layer_name, parameters,
                 activation='relu'):
